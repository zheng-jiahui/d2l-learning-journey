...
if __name__ == '__main__':
    ...
    # 数据集所在根目录
    # https://storage.--weights.com/download.tensorflow.org/example_images/flower_photos.tgz
    parser.add_argument('--data-path', type=str,
                        default="../../data/flower_photos")

    # 预训练权重路径，如果不想载入就设置为空字符
    parser.add_argument('--weights', type=str, default='../../data/mobilevit_s.pt',
                        help='../../data/mobilevit_s.pt')
    # 是否冻结权重
